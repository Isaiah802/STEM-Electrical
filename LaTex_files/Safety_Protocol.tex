...
\subsection*{[DO] Store batteries in LiPo safety bag at ALL times when not in use}

\subsection*{[DO] Charge batteries in LiPo safety bag on non-flammable surface}

\subsection*{[DO] Supervise charging at all times (NEVER leave unattended)}

\subsection*{[DO] Use only the provided B6 balance charger (4S LiPo mode, 1C rate max)}

\subsection*{[DO] Check cell voltages before each use: 3.7V $\pm$ 0.1V per cell}

\subsection*{[DO] Disconnect battery immediately after use}

\subsection*{[DO] Store at 3.8V per cell (storage charge) if not using for >1 week}

\subsection*{[DO] Inspect battery before each use: Look for damage, swelling, or deformation}

\subsection*{[DO] Transport batteries in LiPo bag, padded container}

\subsection*{[DO] Keep fire extinguisher (ABC or CO$_2$ rated) nearby during charging}

\subsection*{[DO NOT]:}

\subsection*{[DO NOT] NEVER charge unattended or overnight}

\subsection*{[DO NOT] NEVER discharge below 3.3V per cell (13.2V total) - causes permanent damage}

\subsection*{[DO NOT] NEVER overcharge above 4.2V per cell (16.8V total) - fire risk}

\subsection*{[DO NOT] NEVER charge at >1C rate (2.2A max for our 2200mAh battery)}

\subsection*{[DO NOT] NEVER puncture, crush, or short-circuit battery terminals}

\subsection*{[DO NOT] NEVER store fully charged (fire risk increases over time)}

\subsection*{[DO NOT] NEVER use damaged or swollen batteries (dispose properly)}

\subsection*{[DO NOT] NEVER expose to water (LiPo + water = dangerous reaction)}

\subsection*{[DO NOT] NEVER charge in hot environment (>40$^\circ$C / 104$^\circ$F)}

\subsection*{[DO NOT] NEVER use damaged charger or wrong battery settings}
...
\subsection*{[ ] If any cell <3.0V or >4.3V $\rightarrow$ DO NOT CHARGE $\rightarrow$ Report to lead}
...
\subsection*{[ ] Monitor battery temperature (should be warm, not hot - <45$^\circ$C)}

\subsection*{[ ] If battery becomes hot (>50$^\circ$C), smells unusual, or swells $\rightarrow$ STOP IMMEDIATELY}

\subsection*{Step 5: Post-Charge}

\subsection*{[ ] Charger will beep when complete (all cells at 4.20V $\pm$ 0.01V)}
...
\subsection*{[DO] Remove propeller for ALL bench testing indoors}

\subsection*{[DO] Install propeller ONLY immediately before flight}

\subsection*{[DO] Verify propeller securely attached (check spinner nut tight)}

\subsection*{[DO] Stand behind propeller plane of rotation when arming motor}

\subsection*{[DO] Shout "PROPELLER TEST" before any motor test outdoors}

\subsection*{[DO] Establish 10-meter safety perimeter for motor tests}

\subsection*{[DO] Inspect propeller before each flight (no cracks, no damage)}

\subsection*{[DO] Use folding propeller as designed (blades fold back for water landing)}

\subsection*{[DO NOT] DO NOT:}

\subsection*{[DO NOT] NEVER test motor with propeller attached indoors}

\subsection*{[DO NOT] NEVER reach toward spinning propeller}

\subsection*{[DO NOT] NEVER arm motor with people in front of aircraft}

\subsection*{[DO NOT] NEVER use damaged or cracked propeller (causes imbalance, shattering risk)}

\subsection*{[DO NOT] NEVER overtighten propeller (can crack hub)}

\subsection*{[DO NOT] NEVER stand in front of aircraft when battery connected}
...
\subsection*{[DO] Use soldering iron in well-ventilated area (fume extraction if available)}

\subsection*{[DO] Wear safety glasses (solder can splatter)}

\subsection*{[DO] Use soldering iron stand (never lay hot iron on bench)}

\subsection*{[DO] Set temperature to 350$^\circ$C (660$^\circ$F) for lead-free solder}

\subsection*{[DO] Wash hands after soldering (lead exposure risk)}

\subsection*{[DO] Allow solder joints to cool before handling}

\subsection*{[DO] Unplug iron immediately after use}

\subsection*{[DO] Keep flammable materials away from soldering area}

\subsection*{[DO NOT] DO NOT:}

\subsection*{[DO NOT] Touch soldering iron tip (causes severe burns)}

\subsection*{[DO NOT] Inhale solder fumes directly (contains flux vapors)}

\subsection*{[DO NOT] Solder near LiPo batteries (heat can cause thermal runaway)}

\subsection*{[DO NOT] Use wet sponge with excessive water (steam can burn)}

\subsection*{[DO NOT] Leave soldering iron unattended while hot}
...
\subsection*{[DO] Use heat shrink tubing on all solder joints}

\subsection*{[DO] Keep tools (screwdrivers, pliers) away from exposed battery terminals}

\subsection*{[DO] Disconnect battery during ALL wiring work}

\subsection*{[DO] Use XT60 connector covers when battery not in use}

\subsection*{[DO] Secure all wires (prevent fraying and short circuits)}

\subsection*{[DO] Test continuity BEFORE connecting battery (check for shorts with multimeter)}
...
\subsection*{[DO] Ground yourself before handling electronics (touch metal bench/ground)}

\subsection*{[DO] Use ESD wrist strap if available}

\subsection*{[DO] Handle circuit boards by edges (avoid touching components)}

\subsection*{[DO] Work on non-conductive surface (wood, plastic mat - NOT metal)}

\subsection*{[DO] Store components in anti-static bags when not in use}

\subsection*{[DO NOT] Avoid working in low-humidity environments (increases static buildup)}

\subsection*{[DO NOT] Avoid wearing synthetic fabrics (wool, polyester generate static)}

\section{SECTION 4: WORKSHOP \& TESTING SAFETY}

\subsection*{GENERAL WORKSHOP SAFETY}

\subsection*{[DO] Maintain clean, organized workspace (clutter causes accidents)}

\subsection*{[DO] Wear safety glasses during soldering, drilling, cutting}

\subsection*{[DO] Keep food and drinks away from electronics (spill risk)}

\subsection*{[DO] Label all wires and components clearly (prevents wiring errors)}

\subsection*{[DO] Use proper tools for each task (reduces damage and injury risk)}

\subsection*{[DO] Report damaged tools or equipment to lead immediately}

\subsection*{[DO] Know location of first aid kit and fire extinguisher}

\subsection*{[DO NOT] Do not work alone on high-risk tasks (battery charging, motor tests)}

\subsection*{[DO NOT] Do not rush (mistakes cause safety hazards)}

\subsection*{[DO NOT] Do not bypass safety procedures to save time}
...
\subsection*{[ ] 13. Check battery voltage (should be >14.0V, if lower $\rightarrow$ recharge)}

\subsection*{[ ] 14. Check component temperatures (motor, ESC should be warm, not hot >50$^\circ$C)}

\subsection*{MULTIMETER SAFETY}

\subsection*{[DO] Use correct setting (DC voltage for batteries, continuity for ground checks)}

\subsection*{[DO] Start with highest range and work down (prevents overload)}

\subsection*{[DO] Red probe to positive (+), black probe to negative (-) or ground}

\subsection*{[DO] Do not measure voltage and current simultaneously (damage to meter)}

\subsection*{[DO NOT] Do not probe live high-voltage circuits (>50V) without training}

\subsection*{[DO NOT] Do not touch metal probe tips while measuring (shock risk)}

\subsection*{[DO NOT] Do not measure current in voltage mode (blows fuse)}
...
\subsection*{[DO] Conduct pre-work safety briefing (5 minutes)}

\subsection*{[DO] Monitor battery charging (if occurring during meeting)}

\subsection*{[DO] Enforce propeller removal during bench testing}

\subsection*{[DO] Ensure fire extinguisher and first aid kit accessible}

\subsection*{[DO] Stop any unsafe activity immediately (authority to halt work)}

\subsection*{[DO] Verify post-work cleanup and battery storage}
...
\subsection*{[DO] Ensure all team members read and sign safety protocol}

\subsection*{[DO] Provide safety training before first hands-on work}

\subsection*{[DO] Approve all battery charging operations}

\subsection*{[DO] Inspect all wiring before first power-up}

\subsection*{[DO] Supervise first motor test for each team member}

\subsection*{[DO] Maintain safety equipment (fire extinguisher, first aid kit)}

\subsection*{[DO] Report all incidents to club advisors immediately}

\subsection*{ALL TEAM MEMBERS}

\subsection*{You are responsible for:}

\subsection*{[DO] Reading this entire safety protocol before starting work}

\subsection*{[DO] Asking questions if anything is unclear}

\subsection*{[DO] Following ALL safety procedures without exception}

\subsection*{[DO] Speaking up if you see unsafe behavior (no exceptions for leadership)}

\subsection*{[DO] Reporting near-misses or accidents immediately}

\subsection*{[DO] Refusing to perform tasks you're not trained for}
